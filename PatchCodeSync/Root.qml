...
//~ TextID f1906ccf-cbda-11e3-85cf-08edb9db5203
    ...
    Item {
        ...
        StatusBar {
            ...
            visible: masterLayout.statusBarAlwaysVisible
                     || ((parent.fullScreenViewActive === 0
                          || (parent.fullScreenViewActive >= 1
                              && parent.fullScreenUsesNormalStatusBar >= 1))
                         && parent.topScreenViewActive === 0)  && ViewController.activeViewMode !== HmiGui.FarewellViewMode
...
//~ TextID f19093e0-cbda-11e3-aa33-08edb9db5203
        ...
        // FORDSYNC3-38450: qsTr usage removed from degrees as translation not needed
