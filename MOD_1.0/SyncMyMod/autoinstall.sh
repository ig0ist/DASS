#!/bin/sh
######################################################################################################
#																	Installation Script for DASS Mod     															 #
######################################################################################################
#                                    _        ___  _     _                                           #
#                                   (_)      / _ \(_)   | |                                          #
#                                    _  __ _| | | |_ ___| |_                                         #
...
mkdir /fs/mp/fordhmi/qml/dirpathedroot
cp ${APP_DIR}/dirpathedroot/PathedRoot.qml			/fs/mp/fordhmi/qml/dirpathedroot/PathedRoot.qml
